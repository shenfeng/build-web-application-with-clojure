...
... artifacts are [released to Clojars](https://clojars.org/example). If you are using Maven, add the following repository
...
example is built from the ground up for Clojure 1.5.1 and up.


## Continuous Integration Status

[![Continuous Integration status](https://secure.travis-ci.org/clojurewerkz/example.png)](http://travis-ci.org/clojurewerkz/example)



## ... Is a ClojureWerkz Project

example is part of the [group of Clojure libraries known as ClojureWerkz](http://clojurewerkz.org), together with
